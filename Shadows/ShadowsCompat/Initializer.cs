...
public static class Initializer
{
    ...
    public static MauiAppBuilder UseSharpnadoShadowsCompat(this MauiAppBuilder builder, bool loggerEnable = false, bool debugLogEnable = false, LoggerDelegate? loggerDelegate = null, string? filter = null)
    {
        ...
        {
#if ANDROID
            handlers.AddHandler<Shadows, Sharpnado.Shades.Droid.ShadowsHandler>();
#elif IOS
            handlers.AddHandler<Shadows, Sharpnado.Shades.iOS.ShadowsHandler>();
#endif
        });
